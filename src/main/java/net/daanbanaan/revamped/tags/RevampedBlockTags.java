...
public class RevampedBlockTags {
	...
	public static final TagKey<Block> WOODEN_TILES = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(Revamped.MOD_ID, "wooden_tiles"));
	public static final TagKey<Block> WOODEN_TILE_STAIRS = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(Revamped.MOD_ID, "wooden_tile_stairs"));
	public static final TagKey<Block> WOODEN_TILE_SLABS = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(Revamped.MOD_ID, "wooden_tile_slabs"));
