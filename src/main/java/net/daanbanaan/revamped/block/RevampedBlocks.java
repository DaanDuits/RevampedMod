...
import net.daanbanaan.revamped.block.custom.ChoppingBlockBlock;
...
public class RevampedBlocks {
    ...
    public static final DeferredBlock<Block> CHOPPING_BLOCK = registerBlock("chopping_block", () -> new ChoppingBlockBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).sound(SoundType.WOOD).noOcclusion()));
