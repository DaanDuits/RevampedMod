...
public class RevampedChestLootTableProvider implements LootTableSubProvider {
	...
	public void generate(BiConsumer<ResourceKey<LootTable>, Builder> output) {
		ResourceKey<LootTable> myChestLoot = ResourceKey.create(
		        Registries.LOOT_TABLE, 
		        ResourceLocation.fromNamespaceAndPath(Revamped.MOD_ID, "chests/village/village_lumberjack")
		    );
		
		output.accept(myChestLoot, LootTable.lootTable()
